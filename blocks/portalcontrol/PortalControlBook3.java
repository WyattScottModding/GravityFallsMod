...
public class PortalControlBook3 extends Block implements IHasModel{

	public static AxisAlignedBB PORTALCONTROL;
	public static final PropertyDirection FACING = BlockHorizontal.FACING;
	
	public PortalControlBook3(String name, Material material)
	{
		super(material);
			...
			EnumHand hand, EnumFacing facing, float hitX, float hitY, float hitZ) 
	{
		...
		else
		{
			...
			if(!worldIn.isRemote)
			{
				...
				{
					IBlockState state2 = BlockInit.PORTAL_CONTROLBOOK2BOOK3.getDefaultState().withProperty(FACING, face);
					worldIn.setBlockState(pos, state2);
