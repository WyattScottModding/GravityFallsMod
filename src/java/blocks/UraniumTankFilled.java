...
public class UraniumTankFilled extends Block implements IHasModel{

	public static final AxisAlignedBB URANIUMTANKFILLED = new AxisAlignedBB(0D, 0D, 0D, 1.0D, 1.0D, 1.0D);

	public UraniumTankFilled(String name, Material material)
	{
		super(material);
