...
public class PortalControl extends Block implements IHasModel
{
			...
			EnumHand hand, EnumFacing facing, float hitX, float hitY, float hitZ) 
	{
		if(!worldIn.isRemote)
		{
			...
			if(itemstack.getItem() instanceof Book1)
			{
				...
				if(state.getProperties().get(BOOK1).toString().equals("false"))
					itemstack.shrink(1);

				book2 = state.getProperties().get(BOOK2).toString().equals("true");
				book3 = state.getProperties().get(BOOK3).toString().equals("true");
				light = state.getProperties().get(LIGHT).toString().equals("true");
			...
			else if(itemstack.getItem() instanceof Book2)
			{
				...
				if(state.getProperties().get(BOOK2).toString().equals("false"))
					itemstack.shrink(1);

				book1 = state.getProperties().get(BOOK1).toString().equals("true");
				book3 = state.getProperties().get(BOOK3).toString().equals("true");
				light = state.getProperties().get(LIGHT).toString().equals("true");
			...
			else if(itemstack.getItem() instanceof Book3)
			{
				...
				if(state.getProperties().get(BOOK3).toString().equals("false"))
					itemstack.shrink(1);
	...
	public void onBlockDestroyedByPlayer(World world, BlockPos pos, IBlockState state) 
	{
		if(!world.isRemote)
		{
			boolean book1 = state.getProperties().get(BOOK1).toString().equals("true");
			boolean book2 = state.getProperties().get(BOOK2).toString().equals("true");
			boolean book3 = state.getProperties().get(BOOK3).toString().equals("true");
			boolean light = state.getProperties().get(LIGHT).toString().equals("true");
	...
	public void onBlockHarvested(World world, BlockPos pos, IBlockState state, EntityPlayer player) 
	{
		if(!world.isRemote)
		{
			if(state.getProperties().get(BOOK1).toString().equals("true"))
			{
				EntityItem item = new EntityItem(world);
				item.setItem(new ItemStack(ItemInit.BOOK1));
				item.setPosition(pos.getX(), pos.getY(), pos.getZ());
			...
			if(state.getProperties().get(BOOK2).toString().equals("true"))
			{
				EntityItem item = new EntityItem(world);
				item.setItem(new ItemStack(ItemInit.BOOK2));
				item.setPosition(pos.getX(), pos.getY(), pos.getZ());
			...
			if(state.getProperties().get(BOOK3).toString().equals("true"))
			{
				EntityItem item = new EntityItem(world);
				item.setItem(new ItemStack(ItemInit.BOOK3));
				item.setPosition(pos.getX(), pos.getY(), pos.getZ());
