...
public class PortalControlBook1Book2 extends Block implements IHasModel{

	public static AxisAlignedBB PORTALCONTROL;
	public static final PropertyDirection FACING = BlockHorizontal.FACING;
	

	public PortalControlBook1Book2(String name, Material material)
	{
		super(material);
			...
			EnumHand hand, EnumFacing facing, float hitX, float hitY, float hitZ) 
	{
		...
		else
		{
			...
			if(!worldIn.isRemote)
			{
				...
				{
					IBlockState state2 = BlockInit.PORTAL_CONTROLALLBOOKS.getDefaultState().withProperty(FACING, face);
