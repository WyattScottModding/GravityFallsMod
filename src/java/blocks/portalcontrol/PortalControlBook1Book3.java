...
public class PortalControlBook1Book3 extends Block implements IHasModel{

	public static AxisAlignedBB PORTALCONTROL;
	public static final PropertyDirection FACING = BlockHorizontal.FACING;
	
	public PortalControlBook1Book3(String name, Material material)
	{
		super(material);
			...
			EnumHand hand, EnumFacing facing, float hitX, float hitY, float hitZ) 
	{
		...
		{
			playerIn.setHeldItem(EnumHand.MAIN_HAND, new ItemStack(ItemInit.BOOK3));
		...
		else
		{
			...
			if(item == ItemInit.BOOK3)
			{
				worldIn.setBlockState(pos, BlockInit.PORTAL_CONTROLALLBOOKS.getDefaultState().withProperty(FACING, face));
