...
public class ChunkGeneratorNightmareRealm implements IChunkGenerator
{
    protected static final IBlockState AIR = Blocks.AIR.getDefaultState();
    protected static final IBlockState BEDROCK = Blocks.AIR.getDefaultState();
    
    //Block that is usually Netherrack
    protected static final IBlockState MAIN_BLOCK = BlockInit.ASTEROID.getDefaultState();
    ...
    protected static final IBlockState OTHER_BLOCK1 = Blocks.FIRE.getDefaultState();
    protected static final IBlockState OTHER_BLOCK2 = Blocks.PRISMARINE.getDefaultState();
    ...
    private final WorldGenerator quartzGen = new WorldGenMinable(Blocks.QUARTZ_ORE.getDefaultState(), 14, BlockMatcher.forBlock(Blocks.LAVA));
    private final WorldGenerator magmaGen = new WorldGenMinable(Blocks.MAGMA.getDefaultState(), 33, BlockMatcher.forBlock(Blocks.WEB));
 ...
 //   private final WorldGenStructure HOUSE = new WorldGenStructure("House");
    ...
    public ChunkGeneratorNightmareRealm(World world, boolean generate, long seed)
    {
        this.world = world;
    ...
    public Chunk generateChunk(int x, int z)
    {
        ...
        {
            abyte[i] = (byte)Biome.getIdForBiome(BiomeInit.NIGHTMAREREALM);
        }
