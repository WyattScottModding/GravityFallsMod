...
public class ChunkGeneratorNightmareTest implements IChunkGenerator
{
    /** RNG. */
    private final Random rand;
    protected static final IBlockState END_STONE = BlockInit.ASTEROID.getDefaultState();
    ...
    private MapGenNightmareRealm endCityGen = new MapGenNightmareRealm(this);
    ...
    public ChunkGeneratorNightmareTest(World p_i47241_1_, boolean p_i47241_2_, long p_i47241_3_, BlockPos p_i47241_5_)
    {
        ...
        this.endCityGen = (MapGenNightmareRealm) net.minecraftforge.event.terraingen.TerrainGen.getModdedMapGen(this.endCityGen, net.minecraftforge.event.terraingen.InitMapGenEvent.EventType.END_CITY);   
    }
   
    public void createStartingPlatform() {
    	
    	for(int x = 998; x <= 1002; x++) {
    		for(int z = 998; z <= 1002; z++) {
    	    	world.setBlockState(new BlockPos(x, 99, z), BlockInit.ASTEROID.getDefaultState());
        	}
    	}
    }
