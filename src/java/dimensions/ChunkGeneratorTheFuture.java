...
//This amazing class was created by Harry's Tech Reviews - go check out his YouTube channel!

public class ChunkGeneratorTheFuture implements IChunkGenerator
{
	//Block that replaces End Stone
	protected static final IBlockState MAIN_BLOCK = Blocks.GRASS.getDefaultState();
   ...
   // private final BlockPos spawnPoint;
    ...
    public ChunkGeneratorTheFuture(World world, boolean mapFeaturesEnabled, long seed)
    {
        this.world = world;
    ...
    public static float getIslandHeightValue(int x, int z, int p_185960_3_, int p_185960_4_)
    {
        ...
        for (int i = -12; i <= 12; ++i)
        {
            for (int j = -12; j <= 12; ++j)
            {
                ...
                if (k * k + l * l > 4096L && ChunkGeneratorTheFuture.islandNoise.getValue((double)k, (double)l) < -0.8999999761581421D)
                {
    ...
    public void populate(int x, int z)
    {
        ...
        if (this.mapFeaturesEnabled)
        {
        	...
        	//e. this.endCityGen.generateStructure(this.world, this.rand, new ChunkPos(x, z));
        }
