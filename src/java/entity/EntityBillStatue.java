...
public class EntityBillStatue extends EntityLivingBase {

    public static final DataParameter<Byte> STATUS = EntityDataManager.<Byte>createKey(EntityBillStatue.class, DataSerializers.BYTE);
    ...
    public EntityBillStatue(World worldIn)
    {
        super(worldIn);
    ...
    public EntityBillStatue(World worldIn, double posX, double posY, double posZ)
    {
        this(worldIn);
