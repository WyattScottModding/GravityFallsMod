...
public class EntityCipherWheel extends EntityLivingBase {

    public static final DataParameter<Byte> STATUS = EntityDataManager.<Byte>createKey(EntityCipherWheel.class, DataSerializers.BYTE);
    ...
    public EntityCipherWheel(World worldIn)
    {
        super(worldIn);
    ...
    public EntityCipherWheel(World worldIn, double posX, double posY, double posZ)
    {
        this(worldIn);
    ...
    public boolean attackEntityFrom(DamageSource source, float amount)
    {
        if (!this.world.isRemote && !this.isDead)
        {
            ...
            else if (!this.isEntityInvulnerable(source) && !this.canInteract && !this.hasMarker())
            {
                ...
                {
                    boolean flag = "player".equals(source.getDamageType());
    ...
    public void handleStatusUpdate(byte id)
    {
        if (id == 32)
        {
            ...
            {
                this.world.playSound(this.posX, this.posY, this.posZ, SoundEvents.BLOCK_STONE_BREAK, this.getSoundCategory(), 0.3F, 1.0F, false);
    ...
    {
        //Block.spawnAsEntity(this.world, new BlockPos(this), new ItemStack(ItemInit.BILL_STATUE));
        this.dropContents();
    }
