...
public class EntityFreezeBeam extends Entity
{
	...
	public EntityFreezeBeam(World world) 
	{
		super(world);
	...
	public EntityFreezeBeam(World world, EntityLivingBase shooter, double accelX, double accelY, double accelZ)
	{
		super(world);
    ...
    {
    	if(shootingEntity instanceof EntityEyeBatHuge)
    	{
    		EntityEyeBatHuge eyeBat = (EntityEyeBatHuge) shootingEntity;
    		
    		eyeBat.setFrozenPlayer(player);
    	}
