...
public class GuiFordWorkbench extends GuiContainer implements IRecipeShownListener
{
    ...
    public GuiFordWorkbench(InventoryPlayer playerInv, World worldIn)
    {
        this(playerInv, worldIn, BlockPos.ORIGIN);
    }

    public GuiFordWorkbench(InventoryPlayer playerInv, World worldIn, BlockPos blockPosition)
    {
