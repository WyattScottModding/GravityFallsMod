...
{
	public static final DimensionType THEFUTURE = DimensionType.register("TheFuture", "_thefuture", ConfigHandler.THE_FUTURE, DimensionTheFuture.class, false);
	public static final DimensionType NIGHTMAREREALM = DimensionType.register("NightmareRealm", "_nightmarerealm", ConfigHandler.NIGHTMARE_REALM, DimensionNightmareRealm.class, false);
