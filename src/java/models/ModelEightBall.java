...
public class ModelEightBall extends ModelBase 
{
	...
	public ModelEightBall()
	{
		...
		this.leftFoot = new ModelRenderer(this, 0, 65);
		...
		this.rightFoot = new ModelRenderer(this, 0, 65);
		...
		this.leftLeg = new ModelRenderer(this, 0, 65);
		...
		this.leftArm = new ModelRenderer(this, 0, 65);
		...
		this.rightArm = new ModelRenderer(this, 0, 65);
		...
		this.rightEar1 = new ModelRenderer(this, 0, 65);
		...
		this.rightEar2 = new ModelRenderer(this, 0, 65);
		...
		this.rightEar3 = new ModelRenderer(this, 0, 65);
		...
		this.rightEar4 = new ModelRenderer(this, 0, 65);
		...
		this.leftEar1 = new ModelRenderer(this, 0, 65);
		...
		this.leftEar2 = new ModelRenderer(this, 0, 65);
		...
		this.leftEar3 = new ModelRenderer(this, 0, 65);
		...
		this.leftEar4 = new ModelRenderer(this, 0, 65);
