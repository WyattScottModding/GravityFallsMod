...
public class TileEntityBeam extends TileEntityLockable implements ITickable, ISidedInventory
{
    ...
    private final List<TileEntityBeam.BeamSegment> beamSegments = Lists.<TileEntityBeam.BeamSegment>newArrayList();
    ...
    private void updateSegmentColors()
    {
        ...
        TileEntityBeam.BeamSegment tileentitybeacon$beamsegment = new TileEntityBeam.BeamSegment(EnumDyeColor.WHITE.getColorComponentValues());
        ...
        for (int i1 = j + 1; i1 < 256; ++i1)
        {
            ...
            {
                tileentitybeacon$beamsegment = new TileEntityBeam.BeamSegment(afloat);
                this.beamSegments.add(tileentitybeacon$beamsegment);
            }
    ...
    @SideOnly(Side.CLIENT)
    public List<TileEntityBeam.BeamSegment> getBeamSegments()
    {
