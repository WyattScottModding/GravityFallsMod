...
public class TileEntityComputer extends TileEntity implements IInventory, ITickable
{
	...
	{
		return this.hasCustomName() ? this.customName : "container.computer_open";
	}
	...
	{
		return "gravityfalls:computer_open";
	}
