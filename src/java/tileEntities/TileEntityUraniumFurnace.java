...
public class TileEntityUraniumFurnace extends TileEntity implements IInventory, ITickable
{
	...
	{
		return this.hasCustomName() ? this.customName : "container.uranium_furnace";
	}
	...
	public void setInventorySlotContents(int index, ItemStack stack1) 
	{
		...
		{
			ItemStack stack2 = (ItemStack)this.inventory.get(index + 1);
			ItemStack stack3 = (ItemStack)this.inventory.get(index + 1);
	...
	public void update()
	{
		...
		if(!this.world.isRemote)
		{
			...
			if(this.isBurning() || !stack.isEmpty() && !(((ItemStack)this.inventory.get(1)).isEmpty() || ((ItemStack)this.inventory.get(2)).isEmpty()) || ((ItemStack)this.inventory.get(3)).isEmpty())
			{
			...
			{
				flag1 = true;
				UraniumFurnace.setState(this.isBurning(), this.world, this.pos);
			}
		}
		if(flag1)
			this.markDirty();
