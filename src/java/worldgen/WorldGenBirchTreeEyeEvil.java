...
public class WorldGenBirchTreeEyeEvil extends WorldGenAbstractTree
{
	public static final PropertyDirection FACING = BlockDirectional.FACING;

	private static final IBlockState LOG = BlockInit.BIRCH_LOG_EYE_EVIL.getDefaultState();
	private static final IBlockState LOG_NORMAL = BlockInit.BIRCH_LOG_EYE_NORMAL_EVIL.getDefaultState();
	...
	public WorldGenBirchTreeEyeEvil(boolean notify, boolean useExtraRandomHeightIn)
	{
		super(notify);
	...
	public boolean generate(World worldIn, Random rand, BlockPos position)
	{
		...
		position = new BlockPos(position.getX(), rand.nextInt(60) + 30, position.getZ());
		
		if (position.getY() >= 1 && position.getY() + i + 1 <= 100)
		{
			...
			else
			{
				...
				boolean isSoil = state.getBlock().canSustainPlant(state, worldIn, down, net.minecraft.util.EnumFacing.UP, (net.minecraft.block.BlockSapling)Blocks.SAPLING) || state.getBlock() == BlockInit.ASTEROID;
	...
	public boolean growSapling(World worldIn, Random rand, BlockPos position)
	{
